...
import static Primitives.Utile.*;
 ...
 */
 final  class Coordinate {
    ...
    public  double sub(Coordinate coor){
        return this.coord-coor.coord;

    }
    public  double add(Coordinate coor) {
        return this.coord + coor.coord;

    }
    public  double mult(Coordinate coor) {
        return this.coord *coor.coord;

    }
    public  double divide(double coor) {
        return this.coord /coor;
