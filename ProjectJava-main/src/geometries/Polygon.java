...
public class Polygon extends Geometry {
    ...
    public List<GeoPoint> findGeoIntersections(Ray ray) {
        ...
        // check if there is a point of intersection with the plane
        ...
        /**
         * V dir of the ray
         * P0 its the start point of the ray
         * V1= P1-P0
         * V2= P2-P0
         */
        Vector v = ray.getDir();
        ...
        //Then, check if the intersection point is inside triangle (and the plane)
        /**
         * n1=normilaze(v1xv2)
         *t= v* n1
         */
        double t = v.dotProduct(v1.crossProduct(v2).normalize());
        if (isZero(t)) { // if t==0 there is no intersection.
            return null;
        }

        boolean sign = t > 0;
        int size = _vertices.size();// sum all the points of the Polygon

        /**
         * vn= list of point (size-1) - Po
         * t=
         *  * n2=normilaze(vnxv1)
         *  *t= v* n1
         */
        ...
        /**
         * if t=0 or
         * t sign are difrent sign of t above  (- / +)
         *
        ...
        /**
         * instead of return intersections , we did return  List ... to cover triangle case
         */
